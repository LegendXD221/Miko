    ...
    client.on(Discord.Events.InteractionCreate, async (interaction) => {
        ...
        if (interaction.customId == "Bot-helppanel") {
            if (interaction.values == "commands-Bothelp") {
                    ...
                    .addComponents(
                        new Discord.StringSelectMenuBuilder()
                            ...
                            .addOptions([
                                {
                                    label: `Commands`,
                                    description: `Explore Miko’s command collection ✿`,
                                    emoji: "💻",
                                    value: "commands-Bothelp",
                                },
                                {
                                    label: `Invite`,
                                    description: `Bring Miko to your server 🎀`,
                                    emoji: "📨",
                                    value: "invite-Bothelp",
                                },
                                {
                                    label: `Support server`,
                                    description: `Get cozy support from the community`,
                                    emoji: "❓",
                                    value: "support-Bothelp",
                                },
                                {
                                    label: `Changelogs`,
                                    description: `See what’s new in Miko`,
                                    emoji: "📃",
                ...
                client.embed({
                    title: `🌸・Miko’s help garden`,
                    desc: `Pick a command category and let Miko help you grow your community ✿\n\n[Invite](${client.config.discord.botInvite}) | [Support](${client.config.discord.serverInvite})`,
