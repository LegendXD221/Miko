...
module.exports = (client) => {
    client.templateEmbed = function () {
        return new Discord.EmbedBuilder()
            .setAuthor({
                name: `${client.config.brand?.signature || client.user.username}`,
    ...
    client.errNormal = async function ({
        ...
        embed.setDescription(`Something went wrong, but Miko is still trying her best ✿`)
        embed.addFields( 
    ...
    client.errUsage = async function ({
        ...
        embed.setTitle(`${client.emotes.normal.error}・Error!`)
        embed.setDescription(`Miko needs a tiny bit more information to help you ✿`)
        embed.addFields(
    ...
    client.errMissingPerms = async function ({
        ...
        embed.setTitle(`${client.emotes.normal.error}・Error!`)
        embed.setDescription(`You do not have the permissions needed for this command ✿`)
        embed.addFields(
    ...
    client.errNoPerms = async function ({
        ...
        embed.setTitle(`${client.emotes.normal.error}・Error!`)
        embed.setDescription(`Miko does not have the permissions needed for this command ✿`)
        embed.addFields(
            { name: "🔑┆Required Permission", value: `\`\`\`${perms}\`\`\``},
        )
        embed.setColor(client.config.colors.error)
    ...
    client.errWait = async function ({
        ...
        embed.setTitle(`${client.emotes.normal.error}・Error!`)
        embed.setDescription(`You already did this recently — give Miko a moment ✿`)
        embed.addFields(
    ...
    client.succNormal = async function ({
        ...
        embed.setTitle(`${client.emotes.normal.check}・Yay, success!`)
